...
import { spinnerContainer, spinnerBase, isBlock, mxAuto, spinnerLayer, layer1, layer2, layer3, layer4 } from './image-spinner.module.scss'
...
export default function ImageSpinner () {
    return (
        <div className={spinnerContainer}>
            <img
                src={techChart}
                className={cx(spinnerBase, isBlock, mxAuto)}
                width="445"
                height="445"
                alt="spinner layer"
            />
